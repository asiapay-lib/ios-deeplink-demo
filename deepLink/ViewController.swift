...
class ViewController: UIViewController {
    ...
    @IBAction func call(_ sender: Any) {
        let str = PayGate_uat.PAYDOLLAR.rawValue + "b2cDemo/eng/payment/payForm.jsp?" + "secureHash=" + Values.secureHash + "&amount=" + Values.amount + "&currCode=" + Values.currCode + "&payType=N&orderRef=" + Values.orderRef + "&merchantId=" + Values.merchantId
